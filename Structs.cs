...
namespace OpenNUI.Unity.Library
{
    ...
    public struct Vec3
    {
        ...
        public static Vec3 operator +(Vec3 op1, Vec3 op2)
        {
    ...
    public struct Vec2
    {
        ...
        public static Vec2 operator +(Vec2 op1, Vec2 op2)
        {
    ...
    public struct NuiJoint
    {
        ...
        internal NuiJoint(double x, double y, double z, JointType type, TrackingState state)
        {
    ...
    public struct NuiJointOrientation
    {
        ...
        internal NuiJointOrientation(JointType type, float x, float y, float z, float w)
        {
            this.type = type;
            this.x = x;
            this.y = y;
    ...
    public class DepthData
    {
        ...
        internal DepthData(ushort[] data, DepthInfo info)
        {
            this.FrameData = data;
    ...
    {
        public readonly Dictionary<JointType, NuiJoint> Joints;
        public readonly Dictionary<JointType, NuiJointOrientation> Orientations;
        public readonly int Id;
        public readonly bool Valid;
        public readonly HandStatus LeftHand;
        public readonly HandStatus RightHand;
        public readonly NuiSensor Sensor;
        internal BodyData(Dictionary<JointType, NuiJoint> joints, Dictionary<JointType, NuiJointOrientation> orientations, bool valid, int id, NuiSensor sensor, HandStatus leftHand, HandStatus rightHand)
        {
            this.Joints = joints;
